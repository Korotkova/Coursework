...
public class TransportTask extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jSpinner1 = new javax.swing.JSpinner(numberModel1);
        jSpinner2 = new javax.swing.JSpinner(numberModel2);
        ...
        jLabel1.setText("Транспортная задача");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel2.setText("Для решения задачи укажите её размерность");

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel3.setText("Количество спроса");

        jLabel4.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel4.setText("Количество предложений");
    ...
    private final SpinnerNumberModel numberModel1 = new SpinnerNumberModel(1, 1, 6, 1);
